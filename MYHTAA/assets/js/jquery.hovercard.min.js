    ...
    $.fn.hovercard = function (options) {
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    ...
                                    '.hc-details { left:-10px;  text-align:left; font-family:Sans-serif !important; font-size:12px !important; color:#666 !important; line-height:1.5em; border:solid 1px #ddd; position:absolute;border-radius:3px;top:-15px;padding:0.25em 1px 1px;box-shadow:2px 2px 2px #888;display:none;}' +
                                    ...
                                    '.hc-details-open-top { bottom:20px; top:auto; padding: 1px 1px 0.25em;} ' +
                                    '.hc-details-open-top > .hc-pic { float:right;  }' +
                                    '.hc-details .s-action{ position: absolute; top:8px; right:5px; } ' +
                                    '.hc-details .s-card-pad{ border-top: solid 1px #eee; margin-top:10px; overflow:hidden; } ' +
        ...
        return this.each(function () {
            ...
            function adjustToViewPort(hcPreview) {
                ...
                var hcdTop = hcPreviewRect.top - 50; //Subtracting 20px of padding;
                var hcdRight = hcPreviewRect.left  + hcDetails.width(); //Adding 35px of padding;
                var hcdBottom = hcPreviewRect.top- 50 + hcDetails.height(); //Adding 35px of padding;
                var hcdLeft = hcPreviewRect.top - 15; //Subtracting 10px of padding;
